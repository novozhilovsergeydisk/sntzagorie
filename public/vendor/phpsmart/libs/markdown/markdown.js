!function(e, t) {
    var n = t();
    if ("object" == typeof n) {
        var r = ["object" == typeof module && "object" == typeof module.exports ? module.exports : null, "undefined" != typeof window ? window : null, e && e !== window ? e : null];
        for (var i in n)
            r[0] && (r[0][i] = n[i]),
            r[1] && "__esModule" !== i && (r[1][i] = n[i]),
            r[2] && (r[2][i] = n[i])
    }
}(this, function() {
    return function(e) {
        ...
        241: function(e, t, n) {
            (function(e, r) {
                ...
                t.format = function(e) {
                    ...
                    n = 1;
                    for (var r = arguments, o = r.length, l = String(e).replace(i, function(e) {
                        if ("%%" === e)
                            return "%";
                        if (n >= o)
                            return e;
                ...
                function u(e, n, r) {
                    ...
                    if (e.showHidden && (l = Object.getOwnPropertyNames(n)),
                    w(n) && (l.indexOf("message") >= 0 || l.indexOf("description") >= 0))
                        return f(n);
                    if (0 === l.length) {
                        if (x(n)) {
                            var a = n.name ? ": " + n.name : "";
                    ...
                    (p(n) && (j = !0,
                    S = ["[", "]"]),
                    x(n)) && (m = " [Function" + (n.name ? ": " + n.name : "") + "]");
                    return _(n) && (m = " " + RegExp.prototype.toString.call(n)),
                    k(n) && (m = " " + Date.prototype.toUTCString.call(n)),
                    w(n) && (m = " " + f(n)),
                    0 !== l.length || j && 0 != n.length ? r < 0 ? _(n) ? e.stylize(RegExp.prototype.toString.call(n), "regexp") : e.stylize("[Object]", "special") : (e.seen.push(n),
                    c = j ? function(e, t, n, r, i) {
                        for (var o = [], l = 0, s = t.length; l < s; ++l)
                            M(t, String(l)) ? o.push(h(e, t, n, r, String(l), !0)) : o.push("");
                        return i.forEach(function(i) {
                            i.match(/^\d+$/) || o.push(h(e, t, n, r, i, !0))
                        }),
                        o
                    }(e, n, r, s, l) : l.map(function(t) {
                        return h(e, n, r, s, t, j)
                    }),
                    e.seen.pop(),
                    function(e, t, n) {
                ...
                function h(e, t, n, r, i, o) {
                    ...
                    if ((a = Object.getOwnPropertyDescriptor(t, i) || {
                        value: t[i]
                    }).get ? s = a.set ? e.stylize("[Getter/Setter]", "special") : e.stylize("[Getter]", "special") : a.set && (s = e.stylize("[Setter]", "special")),
                    M(r, i) || (l = "[" + i + "]"),
                    s || (e.seen.indexOf(a.value) < 0 ? (s = d(n) ? u(e, a.value, null) : u(e, a.value, n - 1)).indexOf("\n") > -1 && (s = o ? s.split("\n").map(function(e) {
                        return "  " + e
                    }).join("\n").substr(2) : "\n" + s.split("\n").map(function(e) {
                        return "   " + e
                    ...
                    y(l)) {
                        if (o && i.match(/^\d+$/))
                            return s;
                        (l = JSON.stringify("" + i)).match(/^"([a-zA-Z_][a-zA-Z_0-9]*)"$/) ? (l = l.substr(1, l.length - 2),
                ...
                function _(e) {
                    return m(e) && "[object RegExp]" === j(e)
                }
                function m(e) {
                    return "object" == typeof e && null !== e
                }
                function k(e) {
                    return m(e) && "[object Date]" === j(e)
                }
                function w(e) {
                    return m(e) && ("[object Error]" === j(e) || e instanceof Error)
                }
                function x(e) {
                ...
                t.debuglog = function(e) {
                    if (y(o) && (o = production.NODE_DEBUG || ""),
                    e = e.toUpperCase(),
                    !l[e])
                ...
                t.log = function() {
                    ...
                    n = [S(e.getHours()), S(e.getMinutes()), S(e.getSeconds())].join(":"),
                    [e.getDate(), O[e.getMonth()], n].join(" ")), t.format.apply(t, arguments))
                }
                ,
                t.inherits = n(239),
            ...
            !function(e) {
                ...
                e.toHTMLTree = function(e, t, n) {
                    ...
                    var o = function e(t, n, r) {
                        ...
                        case "code_block":
                            ...
                            i = l ? 2 : 1;
                            var s = ["code"];
                            s.push.apply(s, o.splice(i, o.length - i)),
                            o[i] = s;
                            break;
                        case "inlinecode":
                            o[0] = "code";
                    ...
                    return function e(t) {
                        var n = h(t) ? 2 : 1;
                        for (; n < t.length; )
                            "string" == typeof t[n] ? n + 1 < t.length && "string" == typeof t[n + 1] ? t[n] += t.splice(n + 1, 1)[0] : ++n : (e(t[n]),
                            ++n)
                    }(o),
                    o
                }
                ;
                var o = t.mk_block = function(e, t, n) {
                    1 == arguments.length && (t = "\n\n");
                    var o = new String(e);
                    return o.trailing = t,
                    o.inspect = i,
                    o.toSource = r,
                    void 0 != n && (o.lineNumber = n),
                    o
                }
                ;
                function l(e) {
                ...
                function s(e, t) {
                    ...
                    return function(o, l) {
                        if (this[n][0] == t)
                            return this[n].shift(),
                            [o.length, new i(o.length - t.length)];
                        var s = this[r].slice()
                          , a = this[n].slice();
                        this[n].unshift(t);
                        var c = this.processInline(o.substr(t.length))
                          , u = c[c.length - 1];
                        this[n].shift();
                        return u instanceof i ? (c.pop(),
                        [o.length - u.len_after, [e].concat(c)]) : (this[r] = s,
                        this[n] = a,
                        [t.length, t])
                    }
                }
                t.prototype.split_blocks = function(e, t) {
                    ...
                    var n, r = /([\s\S]+?)($|\n#|\n(?:\s*\n|$)+)/g, i = [], s = 1;
                    for (null != (n = /^(\s*\n)/.exec(e)) && (s += l(n[0]),
                    r.lastIndex = n[0].length); null !== (n = r.exec(e)); )
                        "\n#" == n[2] && (n[2] = "\n",
                        r.lastIndex--),
                        i.push(o(n[1], n[2], s)),
                        s += l(n[0]);
                ...
                t.prototype.processBlock = function(e, t) {
                    var n = this.dialect.block
                      , r = n.__order__;
                    if ("__call__"in n)
                        return n.__call__.call(this, e, t);
                    for (var i = 0; i < r.length; i++) {
                        var o = n[r[i]].call(this, e, t);
                        if (o)
                            return (!u(o) || o.length > 0 && !u(o[0])) && this.debug(r[i], "didn't return a proper array"),
                            o
                    }
                    return []
                }
                    ...
                    block: {
                        atxHeader: function(e, t) {
                            ...
                            if (n) {
                                ...
                                n[0].length < e.length && t.unshift(o(e.substr(n[0].length), e.trailing, e.lineNumber + 2)),
                                [r]
                            }
                        },
                        setextHeader: function(e, t) {
                            ...
                            if (n) {
                                ...
                                return n[0].length < e.length && t.unshift(o(e.substr(n[0].length), e.trailing, e.lineNumber + 2)),
                                [r]
                            }
                        },
                        code: function(e, t) {
                        ...
                        lists: function() {
                            ...
                            function i(e, t, n, r) {
                                if (t)
                                    ...
                                    for (var o = 0; o < n.length; o++) {
                                        var l = n[o];
                                        "string" == typeof l && i.length > 1 && "string" == typeof i[i.length - 1] ? i[i.length - 1] += l : i.push(l)
                                    }
                                }
                            }
                            function l(e, t) {
                                for (var n = new RegExp("^(" + r + "{" + e + "}.*?\\n?)*$"), i = new RegExp("^" + r + "{" + e + "}","gm"), l = []; t.length > 0 && n.exec(t[0]); ) {
                                    var s = t.shift()
                                      , a = s.replace(i, "");
                                    l.push(o(a, s.trailing, s.lineNumber))
                                }
                                return l
                            }
                            function s(e, t, n) {
                            ...
                            return function(o, a) {
                                var u = o.match(n);
                                if (u) {
                                    for (var f, h, p, g = [], d = $(u), v = !1, b = [g[0].list]; ; ) {
                                        for (var y = o.split(/(?=\n)/), _ = "", m = 0; m < y.length; m++) {
                                            var k = ""
                                              , w = y[m].replace(/^\n/, function(e) {
                                                return k = e,
                                              ...
                                              , x = (p = g.length,
                                            new RegExp("(?:^(" + r + "{0," + p + "} {0,3})(" + e + ")\\s+)|(^" + r + "{0," + (p - 1) + "}[ ]{0,4})"));
                                            if (void 0 !== (u = w.match(x))[1]) {
                                                _.length && (i(f, v, this.processInline(_), k),
                                                v = !1,
                                                _ = ""),
                                                ...
                                                if (j > g.length)
                                                    ...
                                                    S || (++j <= g.length ? (g.splice(j, g.length - j),
                                                    d = g[j - 1].list) : (d = $(u),
                                                    f.push(d))),
                                                    f = ["listitem"],
                                                    d.push(f)
                                            ...
                                            w.length > u[0].length && (_ += k + w.substr(u[0].length))
                                        }
                                        _.length && (i(f, v, this.processInline(_), k),
                                        v = !1,
                                        _ = "");
                                        var O = l(g.length, a);
                                        O.length > 0 && (c(g, s, this),
                                        f.push.apply(f, this.toTree(O, [])));
                                        var M = a[0] && a[0].valueOf() || "";
                                        if (!M.match(n) && !M.match(/^ /))
                                            break;
                                        o = a.shift();
                                        var T = this.dialect.block.horizRule(o, a);
                                        if (T) {
                                            b.push.apply(b, T);
                                            break
                                        }
                        ...
                        blockquote: function(e, t) {
                            if (e.match(/^>/m)) {
                                var n = [];
                                if (">" != e[0]) {
                                    for (var r = e.split(/\n/), i = [], l = e.lineNumber; r.length && ">" != r[0][0]; )
                                        i.push(r.shift()),
                                        l++;
                                    var s = o(i.join("\n"), "\n", e.lineNumber);
                                ...
                                for (; t.length && ">" == t[0][0]; ) {
                                    var a = t.shift();
                                    e = o(e + e.trailing + a, a.trailing, e.lineNumber)
                                }
                                var c = e.replace(/^> ?/gm, "")
                                  , u = (this.tree,
                                this.toTree(c, ["blockquote"]))
                                  , p = h(u);
                                return p && p.references && (delete p.references,
                                f(p) && u.splice(1, 1)),
                                n.push(u),
                                n
                            }
                        ...
                        referenceDefn: function(e, t) {
                            ...
                            if (e.match(n)) {
                                ...
                                return i.length && t.unshift(o(i, e.trailing)),
                                []
                            }
                        },
                        para: function(e, t) {
                ...
                t.dialects.Gruber.inline = {
                    __oneElement__: function(e, t, n) {
                        var r, i;
                        return t = t || this.dialect.inline.__patterns__,
                        (r = new RegExp("([\\s\\S]*?)(" + (t.source || t) + ")").exec(e)) ? r[1] ? [r[1].length, r[1]] : (r[2]in this.dialect.inline && (i = this.dialect.inline[r[2]].call(this, e.substr(r.index), r, n || [])),
                        i = i || [r[2].length, r[2]]) : [e.length, e]
                    },
                    ...
                    "[": function(e) {
                        ...
                        if (!r)
                            return [1, "["];
                        var i, o, l = 1 + r[0], s = r[1], a = (e = e.substr(l)).match(/^\s*\([ \t]*([^"']*)(?:[ \t]+(["'])(.*?)\2)?[ \t]*\)/);
                        if (a) {
                            var c = a[1];
                            if (l += a[0].length,
                            c && "<" == c[0] && ">" == c[c.length - 1] && (c = c.substring(1, c.length - 1)),
                            !a[3])
                            ...
                            void 0 !== a[3] && (o.title = a[3]),
                            i = ["link", o].concat(s),
                            [l, i]
                        }
                        return (a = e.match(/^\s*\[(.*?)\]/)) ? (l += a[0].length,
                        i = ["link_ref", o = {
                            ref: (a[1] || String(s)).toLowerCase(),
                            original: n.substr(0, l)
                        }].concat(s),
                        [l, i]) : 1 == s.length && "string" == typeof s[0] ? (i = ["link_ref", o = {
                            ref: s[0].toLowerCase(),
                            original: n.substr(0, l)
                        }, s[0]],
                        [l, i]) : [1, "["]
                ...
                t.buildBlockOrder = function(e) {
                    var t = [];
                    for (var n in e)
                        "__order__" != n && "__call__" != n && t.push(n);
                    e.__order__ = t
                }
                ,
                ...
                t.dialects.Maruku.processMetaHash = function(e) {
                    for (var t = function(e) {
                        ...
                        return n
                    }(e), n = {}, r = 0; r < t.length; ++r)
                        if (/^#/.test(t[r]))
                            n.id = t[r].substring(1);
                        else if (/^\./.test(t[r]))
                            n.class ? n.class = n.class + t[r].replace(/./, " ") : n.class = t[r].substring(1);
                        else if (/\=/.test(t[r])) {
                            var i = t[r].split(/\=/);
                            n[i[0]] = i[1]
                        }
                ...
                t.dialects.Maruku.block.definition_list = function(e, t) {
                    var n, r = /^((?:[^\s:].*\n)+):\s+([\s\S]+)$/, i = ["dl"];
                    if (s = e.match(r)) {
                        for (var o = [e]; t.length && r.exec(t[0]); )
                            o.push(t.shift());
                        for (var l = 0; l < o.length; ++l) {
                            var s, a = (s = o[l].match(r))[1].replace(/\n$/, "").split(/\n/), c = s[2].split(/\n:\s+/);
                            for (n = 0; n < a.length; ++n)
                                i.push(["dt", a[n]]);
                            for (n = 0; n < c.length; ++n)
                                i.push(["dd"].concat(this.processInline(c[n].replace(/(\n)\s+/, "$1"))))
                        }
                        return [i]
                    }
                }
                ...
                t.dialects.Maruku.block.table = function(e, t) {
                    var n, r, i = function(e, t) {
                        (t = t || "\\s").match(/^[\\|\[\]{}?*.+^$]$/) && (t = "\\" + t);
                        for (var n, r = [], i = new RegExp("^((?:\\\\.|[^\\\\" + t + "])*)" + t + "(.*)"); n = e.match(i); )
                            r.push(n[1]),
                            e = n[2];
                        return r.push(e),
                        r
                    ...
                    r[1] = i(r[1].replace(/\|\s*$/, ""), "|"),
                    n = 0; n < r[1].length; n++)
                        o[1][1].push(["th", l[n] || {}].concat(this.processInline(r[1][n].trim())));
                    return c(r[3].replace(/\|\s*$/gm, "").split("\n"), function(e) {
                        var t = ["tr"];
                        for (e = i(e, "|"),
                        n = 0; n < e.length; n++)
                            t.push(["td", l[n] || {}].concat(this.processInline(e[n].trim())));
                        o[2].push(t)
                    }, this),
                    [o]
                }
                ...
                var c, u = Array.isArray || function(e) {
                    return "[object Array]" == Object.prototype.toString.call(e)
                }
                ;
                c = Array.prototype.forEach ? function(e, t, n) {
                ...
                function h(e) {
                    return u(e) && e.length > 1 && "object" == typeof e[1] && !u(e[1]) ? e[1] : void 0
                }
                function g(e) {
                ...
                function d(e) {
                    ...
                    var t = e.shift()
                      , n = {}
                      , r = [];
                    for (!e.length || "object" != typeof e[0] || e[0]instanceof Array || (n = e.shift()); e.length; )
                        r.push(d(e.shift()));
                    var i = "";
                    for (var o in n)
                        i += " " + o + '="' + g(n[o]) + '"';
        ...
        243: function(e, t, n) {
            ...
            var r = n(242)
              , i = {
                ...
                parse: r.parse,
                toHTML: r.toHTML,
                toHTMLTree: r.toHTMLTree,
                renderJsonML: r.renderJsonML
            }
        },
        8: function(e, t) {
            var n, r, i = e.exports = {};
